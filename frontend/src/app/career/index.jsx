...
export default function CareerPage() {
  ...
  return (
    <div className="relative h-[84.13rem] w-full bg-gray-200_01">
              ...
              <div className="w-full px-[1.75rem] sm:px-[1.25rem]">
                <div className="flex flex-col items-start gap-[1.25rem]">
                  <div className="mr-[0.50rem] flex items-center gap-[2.88rem] self-stretch md:mr-0 md:flex-col">
                    ...
                    />
                    <Button color="colors_indigo" size="6xl" className="w-[3.13rem] rounded-[24px] px-[0.63rem]">
                ...
                <Input
                  ...
                  suffix={
                    searchBarValue?.length > 0 ? (
                      <CloseSVG onClick={() => setSearchBarValue("")} height={26} width={26} fillColor="#000000ff" />
                    ) : null
                  }
      ...
      <div className="absolute bottom-[-6.81rem] left-0 right-0 mx-[4.13rem] flex flex-1 flex-col items-start gap-[0.88rem] md:mx-0">
        <Heading size="text6xl" as="h2" className="ml-[0.38rem] text-[1.13rem] font-medium md:ml-0">
          Recommented Colleges as per test result
        </Heading>
        <div className="flex flex-col gap-[1.75rem] self-stretch">
          <CareerGroup675 />
          <div className="mr-[21.25rem] flex gap-[1.50rem] md:mr-0 md:flex-col">
            <Suspense fallback={<div>Loading feed...</div>}>
              {data.map((d, index) => (
                <UserProfile4 {...d} key={"group794" + index} />
              ))}
            </Suspense>
          </div>
        </div>
